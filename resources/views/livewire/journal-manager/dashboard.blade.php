...
<div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
    @php
    $isManagerOrAdmin = auth()->user()->hasAnyRole(['super_admin', 'admin', 'journal_manager']);
    $quickActions = [
    ...
    if ($isManagerOrAdmin) {
        $quickActions[] = ['label'=>'Halaman Jurnal','desc'=>'Buat halaman kustom','icon'=>'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z','color'=>'#0891b2','bg'=>'#ecfeff','url'=>route('manager.pages')];
        $quickActions[] = ['label'=>'Profil Jurnal','desc'=>'Edit info','icon'=>'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z','color'=>'#059669','bg'=>'#f0fdf4','url'=>route('manager.settings')];
    }
    @endphp
