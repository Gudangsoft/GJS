    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div class="flex-1">
                ...
                <h1 class="text-xl font-black text-slate-900">Pencarian Artikel</h1>
            </div>
        </div>
        ...
        <div class="mt-4 flex gap-3">
            <div class="flex-1 relative">
                ...
                <input wire:model.live.debounce.400ms="query"
                       type="text"
                       placeholder="Cari judul, penulis, abstrak, atau kata kunci..."
                       class="w-full pl-10 pr-4 py-2.5 text-sm rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                @if($query)
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="text-center py-16">
        ...
        <p class="text-slate-400 font-medium">Ketik minimal 2 karakter untuk mencari</p>
        <p class="text-slate-300 text-sm mt-1">Cari berdasarkan judul, penulis, abstrak, atau kata kunci</p>
    </div>
    ...
    <div class="text-center py-16">
        ...
        <p class="text-slate-500 font-semibold">Tidak ada hasil untuk "<span class="text-slate-700">{{ $q }}</span>"</p>
        <p class="text-slate-400 text-sm mt-2">Coba kata kunci yang berbeda atau lebih umum</p>
    </div>

    @else
    <div class="flex items-center justify-between mb-5">
        <p class="text-sm text-slate-600">
            Ditemukan <strong class="text-slate-900">{{ $totalCount }}</strong> artikel untuk
