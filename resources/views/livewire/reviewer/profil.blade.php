...
<div style="background:linear-gradient(135deg,#022c22 0%,#064e3b 55%,#059669 100%);position:relative;overflow:hidden;">
    ...
    <div style="padding:2rem 2rem 1.5rem;display:flex;align-items:center;gap:1.75rem;flex-wrap:wrap;">
        ...
        <div style="flex:1;min-width:200px;">
            <p style="font-size:.7rem;font-weight:700;text-transform:uppercase;letter-spacing:.1em;color:#6ee7b7;margin:0 0 .25rem;">Panel Reviewer</p>
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:.75rem;">
            @foreach([
                ['n' => $totalReviews,                                        'label' => 'Selesai',    'color' => '#34d399'],
                ['n' => $avgDays !== null ? $avgDays.'h' : '—',               'label' => 'Rata-Rata',  'color' => '#a78bfa'],
                ['n' => $acceptanceRate !== null ? $acceptanceRate.'%' : '—', 'label' => 'Terima',     'color' => '#fb923c'],
                ['n' => $totalInvited,                                        'label' => 'Undangan',   'color' => '#38bdf8'],
            ] as $s)
...
<div style="padding:1.5rem 2rem;">
    ...
    @if($saved)
    <div style="background:#f0fdf4;border:1px solid #bbf7d0;color:#166534;border-radius:.875rem;padding:.875rem 1.125rem;margin-bottom:1.25rem;display:flex;align-items:center;gap:.625rem;font-size:.875rem;font-weight:600;">
    ...
    <div style="display:grid;grid-template-columns:1fr 300px;gap:1.25rem;align-items:start;" class="profil-grid">
        ...
        <div style="display:flex;flex-direction:column;gap:1.125rem;">
            ...
            <div style="background:#fff;border-radius:1rem;border:1px solid #e2e8f0;box-shadow:0 1px 3px rgba(0,0,0,.05);padding:1.375rem;">
                <h2 style="font-size:.875rem;font-weight:700;color:#0f172a;margin:0 0 1rem;display:flex;align-items:center;gap:.5rem;">
                    <svg style="width:1rem;height:1rem;color:#059669;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                    Informasi Pribadi
                </h2>
                ...
                <div style="display:grid;grid-template-columns:120px 1fr 1fr;gap:.875rem;margin-bottom:.875rem;">
                    ...
                    $iFocus = 'onfocus="this.style.borderColor=\'#059669\';this.style.boxShadow=\'0 0 0 3px rgba(5,150,105,.1)\'" onblur="this.style.borderColor=\'#d1d5db\';this.style.boxShadow=\'none\'"';
                    @endphp
            ...
            <div style="background:#fff;border-radius:1rem;border:1px solid #e2e8f0;box-shadow:0 1px 3px rgba(0,0,0,.05);padding:1.375rem;">
                <h2 style="font-size:.875rem;font-weight:700;color:#0f172a;margin:0 0 1rem;display:flex;align-items:center;gap:.5rem;">
                    <svg style="width:1rem;height:1rem;color:#059669;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                    Afiliasi Institusional
                </h2>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:.875rem;margin-bottom:.875rem;">
                    <div>
                        ...
                        <input wire:model="position" type="text" style="{{ $iStyle }}" {!! $iFocus !!} placeholder="Dosen, Peneliti, dll.">
                    </div>
                    <div>
            ...
            <div style="background:#fff;border-radius:1rem;border:1px solid #e2e8f0;box-shadow:0 1px 3px rgba(0,0,0,.05);padding:1.375rem;">
                ...
                $academicFields = [
                    ...
                    ['key'=>'scopus_id',       'label'=>'Scopus Author ID','hint'=>'Masukkan angka ID saja (tanpa URL)',                 'ph'=>'12345678900',                                    'color'=>'#e87722', 'link'=>fn($v)=>'https://www.scopus.com/authid/detail.uri?authorId='.$v],
                    ['key'=>'researchgate',    'label'=>'ResearchGate',    'hint'=>'URL profil ResearchGate Anda',                      'ph'=>'https://www.researchgate.net/profile/NamaAnda',  'color'=>'#00ccbb', 'link'=>fn($v)=>$v],
                    ['key'=>'sinta_id',        'label'=>'SINTA ID',        'hint'=>'Masukkan angka ID SINTA (Kemendikbud)',             'ph'=>'1234567',                                        'color'=>'#dc2626', 'link'=>fn($v)=>'https://sinta.kemdikbud.go.id/authors/detail?id='.$v],
            ...
            <div style="background:#fff;border-radius:1rem;border:1px solid #e2e8f0;box-shadow:0 1px 3px rgba(0,0,0,.05);padding:1.375rem;">
                <h2 style="font-size:.875rem;font-weight:700;color:#0f172a;margin:0 0 .25rem;display:flex;align-items:center;gap:.5rem;">
                    <svg style="width:1rem;height:1rem;color:#059669;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                    Metrik Publikasi <span style="font-size:.7rem;font-weight:500;color:#94a3b8;margin-left:.25rem;">(opsional, diisi sendiri)</span>
                </h2>
                <p style="font-size:.78rem;color:#94a3b8;margin:0 0 1rem;">Data ini membantu editor menilai kualifikasi Anda sebagai reviewer</p>
            ...
            <div style="background:#fff;border-radius:1rem;border:1px solid #e2e8f0;box-shadow:0 1px 3px rgba(0,0,0,.05);padding:1.375rem;">
                <h2 style="font-size:.875rem;font-weight:700;color:#0f172a;margin:0 0 .25rem;display:flex;align-items:center;gap:.5rem;">
                    <svg style="width:1rem;height:1rem;color:#059669;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/></svg>
                    Bidang Keahlian
                </h2>
                <p style="font-size:.78rem;color:#94a3b8;margin:0 0 1rem;">Tag topik yang Anda kuasai (maks 15 tag)</p>
                ...
                <div style="display:flex;flex-wrap:wrap;gap:.5rem;margin-bottom:.875rem;">
                    ...
                    <span style="display:inline-flex;align-items:center;gap:.375rem;background:#f0fdf4;color:#065f46;border:1px solid #bbf7d0;border-radius:9999px;padding:.25rem .75rem;font-size:.8125rem;font-weight:600;">
                        {{ $tag }}
                        <button type="button" wire:click="removeExpertise({{ $i }})"
                                style="display:flex;align-items:center;justify-content:center;width:1rem;height:1rem;border-radius:50%;background:#86efac22;border:none;cursor:pointer;color:#065f46;font-size:.75rem;padding:0;"
                                title="Hapus">
                            ×
                        </button>
                    </span>
                ...
                <div style="display:flex;gap:.625rem;">
                    <input wire:model="expertiseInput"
                           ...
                           style="{{ $iStyle }}flex:1;"
                           {!! $iFocus !!}
                           placeholder="Ketik topik lalu tekan Enter atau klik Tambah"
                           maxlength="60">
                    <button type="button" wire:click="addExpertise"
                            style="background:#059669;color:#fff;border:none;border-radius:.5rem;padding:.5rem 1rem;font-size:.8125rem;font-weight:700;cursor:pointer;white-space:nowrap;">
                        + Tambah
                    </button>
                </div>
                <p style="font-size:.72rem;color:#94a3b8;margin:.375rem 0 0;">Contoh: Machine Learning, Kesehatan Masyarakat, Hukum Pidana, dsb.</p>
            </div>

            {{-- ── Bio Akademik ─────────────────────────────────────────────── --}}
            <div style="background:#fff;border-radius:1rem;border:1px solid #e2e8f0;box-shadow:0 1px 3px rgba(0,0,0,.05);padding:1.375rem;">
                <h2 style="font-size:.875rem;font-weight:700;color:#0f172a;margin:0 0 .25rem;display:flex;align-items:center;gap:.5rem;">
                    <svg style="width:1rem;height:1rem;color:#059669;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                    Bio Akademik
                </h2>
                <p style="font-size:.78rem;color:#94a3b8;margin:0 0 .875rem;">Deskripsi singkat tentang penelitian, pengalaman, dan minat ilmiah Anda</p>

                <textarea wire:model="bio" rows="6"
                          style="{{ $iStyle }}resize:vertical;line-height:1.6;"
                          {!! $iFocus !!}
                          placeholder="Tuliskan latar belakang akademis, penelitian utama, dan minat review Anda..."></textarea>
            ...
            <div style="display:flex;gap:.75rem;align-items:center;">
                <button type="submit"
                        ...
                        style="background:linear-gradient(135deg,#059669,#047857);color:#fff;border:none;border-radius:.75rem;padding:.75rem 2rem;font-size:.9375rem;font-weight:700;cursor:pointer;display:inline-flex;align-items:center;gap:.625rem;box-shadow:0 4px 14px rgba(5,150,105,.3);">
                ...
                @if($saved)
                <span style="font-size:.875rem;color:#059669;font-weight:600;display:flex;align-items:center;gap:.375rem;">
        ...
        <div style="position:sticky;top:1.5rem;display:flex;flex-direction:column;gap:1rem;">
            ...
            <div style="background:#fff;border-radius:1rem;border:1px solid #e2e8f0;box-shadow:0 2px 8px rgba(0,0,0,.07);overflow:hidden;">
                ...
                {{-- Header --}}
                <div style="background:linear-gradient(135deg,#022c22 0%,#064e3b 60%,#059669 100%);padding:1rem 1.125rem 3.25rem;position:relative;overflow:hidden;">
                    ...
                    <div style="display:flex;align-items:center;gap:.625rem;">
                        ...
                        <img src="{{ $cardLogo }}" alt="{{ $cardSiteName }}"
                             style="height:1.25rem;max-width:2rem;width:auto;object-fit:contain;object-position:left center;filter:brightness(0) invert(1);opacity:.85;flex-shrink:0;">
                        @else
                        ...
                        <div style="min-width:0;">
                            <p style="font-size:.6rem;font-weight:700;text-transform:uppercase;letter-spacing:.1em;color:rgba(255,255,255,.5);margin:0 0 .1rem;">Kartu Reviewer</p>
                ...
                <div style="padding:.75rem 1.125rem 1.125rem;">
                    ...
                    <p style="font-size:.8rem;color:#059669;font-weight:600;margin:.2rem 0 0;">
            ...
            @php
            $fields = ['first_name','affiliation','orcid','google_scholar','bio','expertise_areas','position'];
            $filled = 0;
            foreach($fields as $f) {
            ...
            <div style="background:#fff;border-radius:1rem;border:1px solid #e2e8f0;padding:1.125rem;">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:.625rem;">
                    ...
                    <span style="font-size:.875rem;font-weight:800;color:{{ $pct >= 80 ? '#059669' : ($pct >= 50 ? '#d97706' : '#dc2626') }};">{{ $pct }}%</span>
                </div>
                <div style="height:.5rem;background:#f1f5f9;border-radius:9999px;overflow:hidden;">
                    <div style="height:100%;width:{{ $pct }}%;background:{{ $pct >= 80 ? 'linear-gradient(90deg,#059669,#34d399)' : ($pct >= 50 ? '#d97706' : '#dc2626') }};border-radius:9999px;transition:width .3s;"></div>
                </div>
                @if($pct < 100)
                <ul style="margin:.75rem 0 0;padding-left:1.125rem;font-size:.78rem;color:#64748b;line-height:1.8;">
                    ...
                    @if(empty($expertise_areas))    <li>Tambahkan bidang keahlian</li> @endif
                    @if(empty(trim($bio)))           <li>Tulis bio akademik</li> @endif
                </ul>
                @else
                <p style="font-size:.78rem;color:#059669;font-weight:600;margin:.625rem 0 0;">Profil sudah lengkap!</p>
                @endif
            </div>

            {{-- Tips --}}
            <div style="background:#fffbeb;border:1px solid #fde68a;border-radius:1rem;padding:1rem;">
                <p style="font-size:.8125rem;font-weight:700;color:#92400e;margin:0 0 .5rem;display:flex;align-items:center;gap:.375rem;">
                ...
                <ul style="margin:0;padding-left:1rem;font-size:.78rem;color:#78350f;line-height:1.7;">
                    <li>Editor memilih reviewer berdasarkan keahlian</li>
                    <li>ORCID & Scopus meningkatkan kredibilitas</li>
                    <li>Profil SINTA dibutuhkan untuk akreditasi</li>
                    <li>H-index membantu editor menilai kualifikasi</li>
                </ul>
            </div>
        </div>
