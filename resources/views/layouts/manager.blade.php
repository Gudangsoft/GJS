...
<div class="flex pt-14 min-h-screen">
    ...
    <aside :class="sidebarOpen ? `w-60` : `w-16`"
        ...
        $isManagerOrAdmin = $user->hasAnyRole(['super_admin', 'admin', 'journal_manager']);
        ...
        // Items below require journal_manager or higher role
        if ($isManagerOrAdmin) {
            array_unshift($settingsGroup,
            ...
            $settingsGroup[] = ["label"=>"Halaman Jurnal","icon"=>"M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z","url"=>route("manager.pages"),"match"=>"manager/pages"];
            $settingsGroup[] = ["label"=>"Import dari OJS","icon"=>"M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12","url"=>route("manager.ojs-import"),"match"=>"manager/ojs-import"];
        }
        ...
        $navGroups = [
            ...
            "EDITORIAL" => [
                ...
                ["label"=>"Copy Editing","icon"=>"M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z","url"=>route("manager.copy-editing"),"match"=>"manager/copy-editing"],
            ],
            "TERBITAN" => [
            ...
            "PENGATURAN JURNAL" => $settingsGroup,
            "PENGGUNA" => [
