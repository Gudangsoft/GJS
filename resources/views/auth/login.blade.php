...
@section('content')
    ...
    <p class="text-sm text-slate-500 mb-6">Sign in to access your journal dashboard</p>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-4">
        ...
        <div class="relative my-4">
            ...
            <div class="relative flex justify-center"><span class="px-3 bg-white text-xs text-slate-400">or</span></div>
        </div>
    ...
    <p class="mt-6 text-center text-sm text-slate-500">
        ...
        <a href="{{ route('register') }}" class="text-blue-600 font-medium hover:underline">Register now</a>
    </p>
@endsection
